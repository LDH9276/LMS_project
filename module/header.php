...
?>
    ...
    <header>
      <!-- 상단헤더 -->
      <h1>
        <a href="http://jjy981212.dothome.co.kr/lms/index.php" title="메인페이지로">
          <img src="http://jjy981212.dothome.co.kr/lms/img/logo.svg" alt="헤더 로고" />
        </a>
      </h1>
      <div id="h_wrap">
        ...
        if(isset($_SESSION['lms_logon'])){
          ...
          echo "<a href='http://jjy981212.dothome.co.kr/lms/module/logout.php' title='로그아웃'><i class='fa-solid fa-sign-out'></i></a>";}
        else{
          echo "<a href='http://jjy981212.dothome.co.kr/lms/module/login.php' title='로그인'><i class='fa-solid fa-sign-in'></i></a>";
        }
        ?>
      </div>
      <!-- 사이드 -->
      ...
      <?php
              if(isset($_SESSION['lms_logon'])){ // 로그인이 되어있으면
                echo "<div id='profile'>
                <img src='http://jjy981212.dothome.co.kr/lms/img/profile.png' alt='프로필이미지' />
                <div>";
                ...
                echo "<div id='profile'>
                <img src='http://jjy981212.dothome.co.kr/lms/img/profile2.png' alt='프로필이미지' />
                <div>";
                echo "<p>비회원입니다.</p>";
                echo "<p>로그인해주세요.</p>";
              }
        ...
        <div id="search">
          <form action="http://jjy981212.dothome.co.kr/lms/module/search.php" method="get">
        ...
        ?>
          ...
          <ul id="gnb">
            ...
            <li>
              ...
              <ul class="lnb">
                <li><a href="http://jjy981212.dothome.co.kr/lms/module/user_apply.php" title="수강신청">수강신청</a></li>
        ...
        <?php } else { // 관리자?> 
          <ul id="gnb">
            ...
            <li>
              ...
              <ul class="lnb">
                <li><a href="#" title="LMS 안내사항">LMS 안내사항</a></li>
                <li><a href="http://jjy981212.dothome.co.kr/lms/module/notice_write.php" title="공지사항 작성">공지사항 작성</a></li>
                <li><a href="#" title="명지대 뉴스레터">명지대 뉴스레터</a></li>
                <li><a href="#" title="행정부서">행정부서</a></li>
                <li>
                  <a href="#" title="대학생활 길라잡이">대학생활 길라잡이</a>
        ...
        <div id="h_footer">
          <ul>
            <li>
              <a href="http://jjy981212.dothome.co.kr/lms/module/notice_list.php"
