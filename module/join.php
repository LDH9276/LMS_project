...
<div class="page-nav">
  ...
  <p class="page-nav__desc">
    <i class="fas fa-home"></i> >  <i class="fas fa-user"></i> > 수강신청 관리
  </p>
</div>
...
<script>
      ...
      $('.join_agree').click(function(){
        let total = $(".join_agree").length;
        let checked = $(".join_agree-label:checked").length;
...
가. 이 개인정보 처리방침은 2022.3.2부터 적용됩니다.
  ...
  <div class="j-form-f">
    ...
    <input type="text" class="j-form-input" id="user_id" name="user_id" required>
  </div>
  <div>
  ...
  <div class="j-form-f">
    ...
    <input type="password" class="j-form-input" id="user_password" name="user_password" required>
  </div>
  &nbsp;
  <div class="j-form-f">
  ...
  <div class="j-form-f">
    ...
    <input type="text" class="j-form-input" id="user_email" name="user_email" required>
  </div>
  &nbsp;
  <div class="j-form-f">
